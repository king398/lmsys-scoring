...
CFG = {
    'seed': 42,
    'train_csv': '/mnt/alignment-handbook/LMSYS/train_folds_llama.csv',
    'model_name': 'meta-llama/Meta-Llama-3-8B-Instruct',
    'max_len': 3096,
    'batch_size': 8,
    'num_classes': 3,
    'model_dir': '/mnt/alignment-handbook/models/Meta-Llama-3-8B-Instruct-3096-2-epoch-label-smoothing-fold{fold}',
    'epochs': 2,
    'lr': 4e-5,
